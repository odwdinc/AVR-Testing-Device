...
#define  USB_CFG_VENDOR_ID       0x4f, 0x1b /* = 0x16c0 = 5824 = voti.nl */
 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0x02, 0x00 /* = 0x05dc = 1500 */
 ...
 */
#define USB_CFG_VENDOR_NAME     'w', 'w', 'w', '.', 'T', '-', '4', '2', 'd', '.', 'c', 'o', 'm'
...
// CHANGED
#define USB_CFG_DEVICE_NAME     'U', 'S', 'B', ' ', 'T', 'e', 's', 't', 'i', 'n', 'g', ' ', 'D', 'e', 'v', 'i', 'c', 'e'
